...
kernel void bin_raster(
    ...
    // Private space
    int local_id = get_local_id(0) + get_local_id(1) * 32; // get_max_sub_group_size(); 
    int batch_pos = 0;
    ...
    while (true) {
        ...
        do {
            ...
            while (buf_count < CR_BIN_WARPS*32 && batch_pos < batch_end) {
            ...
            for (int i=get_local_id(0); i < c_num_bins; i += 32)
